...
## Main Features:
- Создание, удаление папок с чатами。
- Создание, удаление чатов, добавление участников。
- Уведомления о непрочитанных сообщениях и непросмотренных запросах в друзья。
- Поддержка полнотекстового поиска по пользователям, добавление друзей。
- Изменение профиля。
